...
Documentation follows the model card \citep{mitchell2019modelcards} and datasheet \citep{gebru2018datasheets} conventions: \texttt{model\_card.md} records intended use, training data, and known limitations for the classifier, and \texttt{datasheet.md} records dataset composition and collection provenance for NIH ChestX-ray14 and RSNA.
