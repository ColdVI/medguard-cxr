...
NIH ChestX-ray14 \citep{wang2017chestxray8} is used for broad image-level multi-label classifier training and evaluation. The labels are silver-standard labels mined from reports, so they may contain label noise and reporting bias. The current classifier was trained through the repository command \texttt{make train}.
